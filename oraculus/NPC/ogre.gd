...
@export var npc_name: String = "Orc"
...
func say_launch_message():
	_send_to_ai_server("You just appeared. Say something BRUSQUE and AGGRESSIVE, as if someone woke you up. Threaten those nearby. Show hunger or annoyance.")

func ask_riddle():
	_send_to_ai_server("A human spoke to you. Growl, scream or threaten. Show annoyance, anger or hunger. Don't tolerate verbal interactions.")
...
func receive_player_answer(answer: String):
	...
	can_attack = true
	attack_timer = 0.0
	_send_to_ai_server("Someone told you: '" + answer + "'. You don't care what they said. Respond badly, growl or threaten them.")
...
func _on_body_entered(body: Node2D):
	if body.name == "Player":
		...
		can_attack = true
		attack_timer = 0.0
		_send_to_ai_server("You saw a human. You hate them at first sight. Growl, threaten and prepare to attack.")
